"""
C25K Korean voice cue generator using edge-tts.
Voice: ko-KR-SunHiNeural (female, neural, energetic)
...
async def main():
    tasks = [generate_cue(name, text, rate, pitch) for name, (text, rate, pitch) in cues.items()]
